...
describe("fetchposts action", () => {
  it("loads posts", () => {
    ...
    expect(fetchPostsSuccess(posts)).toEqual({
...
describe("select posts by category", () => {
  it("loads the selected category posts", () => {
    ...
    expect(fetchPostsByCategorySuccess(posts)).toEqual({
...
describe("selected post", () => {
  it("loads the selected post", () => {
    ...
    expect(fetchSelectedPostSuccess(post)).toEqual({
...
describe("new post create", () => {
  it("submit a new post", () => {
    ...
    expect(newpostCreateSuccess(post)).toEqual({
...
describe("post edit", () => {
  it("updates an existing post", () => {
    ...
    expect(postUpdateSuccess(post)).toEqual({
